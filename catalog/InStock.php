...
<head>
    ...
    <meta property="og:description"
          content="k-store"><!-- Google Tag Manager -->
    ...
    <div class="ogami-breadcrumb">
        <div class="container">
            <ul>
                ...
                <li><a class="breadcrumb-link" href="all.php">Техника</a></li>
                <li><a class="breadcrumb-link active">В наличие</a></li>
            </ul>
        </div>
    </div>
    <!-- End breadcrumb-->
                        ...
                        <div class="shop-products">
                            ...
                            <div class="shop-products_bottom">
                                <div class="row no-gutters-sm">
                                    <?php
                                    $sql = "SELECT * FROM `product` WHERE `In_stock` = 1 ORDER BY name ASC";
