                        ...
                        <div class="mobile-menu_block d-flex align-items-center">
                            ...
                            <div id="   mi-mobile-menu">
                                ...
                                <div class="mobile-social justify-content-center">
                                    ...
                                    <a href="https://web.whatsapp.com/"><i class="fab fa-whatsapp"></i></a>
                                    <a href="https://www.viber.com/en/"><i class="fab fa-viber"> </i></a>
                                    <a href="https://www.instagram.com/kartoshkastoreit/" target="_blank"><i class="fab fa-instagram"> </i></a>
                                </div>
                            </div>
        ...
        <div class="full-fluid">
            <div class="slider_wrapper">
                <div class="slider-block"
                     style="background-image: url('k-store/uploads/uploads/image/slider/back/slider_background_2.png')">
                    <div class="slider-content">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-12 col-md-5 col-xl-6">
                                    <div class="slider-text d-flex flex-column align-items-center align-items-md-start">
                                        <h5 data-animation="fadeInUp" data-delay=".2s">для повседневного
                                            использования</h5>
                                        <h2 class="slider-name" data-animation="fadeInUp" data-delay=".3s">Lenovo
                                            Yoga</h2>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="slider-img parallax-img" data-animation="zoomIn" data-delay=".1s">
                                        <img style="opacity: 1"
                                             data-lazy="k-store/uploads/uploads/image/slider/back/slider_subbackground_1.png"
                                             alt="">
                                        <img class="img"
                                             data-lazy="k-store/uploads/uploads/image/slider/slider_img_2.png" alt=""
                                             data-depth="1">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="slider-block"
                     style="background-image: url('k-store/uploads/uploads/image/slider/back/slider_background_3.png')">
                    <div class="slider-content">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-12 col-md-5 col-xl-6">
                                    <div class="slider-text d-flex flex-column align-items-center align-items-md-start">
                                        <h5 data-animation="fadeInUp" data-delay=".2s">для игр</h5>
                                        <h2 class="slider-name" data-animation="fadeInUp" data-delay=".3s">Asus ROG</h2>
                                        <a class="normal-btn" href="catalog/all.php">Заказать</a>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="slider-img parallax-img" data-animation="zoomIn" data-delay=".1s">
                                        <img style="opacity: 1"
                                             ...
                                             alt="">
                                        <img class="img"
                                             data-lazy="k-store/uploads/uploads/image/slider/slider_img_3.png" alt=""
                                             data-depth="1">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="slider-block"
                     style="background-image: url('k-store/uploads/uploads/image/slider/back/slider_background_1.png')">
                    <div class="slider-content">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-12 col-md-5 col-xl-6">
                                    <div class="slider-text d-flex flex-column align-items-center align-items-md-start">
                                        <h5 data-animation="fadeInUp" data-delay=".2s">для работы над проектами</h5>
                                        <h2 class="slider-name" data-animation="fadeInUp" data-delay=".3s">Macbook
                                            Pro</h2>
                                        <a class="normal-btn" href="catalog/all.php">Заказать</a>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="slider-img parallax-img" data-animation="zoomIn" data-delay=".1s">
                                        <img style="opacity: 1"
                                             ...
                                             alt="">
                                        <img class="img"
                                             data-lazy="k-store/uploads/uploads/image/slider/slider_img_1.png" alt=""
                                             data-depth="1">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="benefit-detail d-flex flex-column align-items-center">
                                    <img class="benefit-img" src="k-store/static/images/ico/otgruz.svg" alt="">
                                    <h5 class="benefit-title">Отгрузка</h5>
                                    <div>
                                        <p class="benefit-describle">Мы начинаем отгружать технику уже после получения
                                            оплаты. Благодаря чему уже через несколько часов заказ спешит к вам. Заказ
                                            приходит строго с установленными строками.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="benefit-detail d-flex flex-column align-items-center">
                                    <img class="benefit-img" src="k-store/static/images/ico/box.svg" alt="">
                                    <h5 class="benefit-title">Упаковка</h5>
                                    <p class="benefit-describle">Наш продукт упакован только в качественную и
                                        сертифицированную упаковку – это позволяет нам привлечь внимание потребителя и
                                        увеличить объем продаж.</p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="benefit-detail boderless d-flex flex-column align-items-center">
                                    <img style="padding: 19px;" class="benefit-img"
                                         src="k-store/static/images/ico/test.svg" alt="">
                                    <h5 class="benefit-title">Cтандарты</h5>
                                    <p class="benefit-describle">У нас введены стандарты и мы работаем по стандартам
                                        круглый год. Вы можете быть уверены – продукция придет согласно заказу, даже на
                                        случай форс-мажора.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center order-1">
                    <h1 class="title green-underline mx-auto mb50">Новинки сезона 2022</h1>
                </div>
            </div>
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    if ($result) {
                        ...
                        <div class="col-12 col-sm-6 col-md-3" style='margin-bottom : 25px; '>
                            <a class="product-item d-flex flex-column align-items-center justify-content-center"
                               href="product/product_page.php?<?php echo $row['id'] ?>">
                                <div class="categories-img">
                                    <img src="k-store/<?php echo $row['picture'] ?>">
                                </div>
        ...
        <div class="banner-block">
            <div class="row no-gutters">
                <div class="col-12 col-lg-3">
                    <div class="banner-block_detail"
                         style="background-image: url(k-store/static/images/home/banner_1.png)">
                        <img src="k-store/static/images/home/banner_img_1.png" alt="">
                        <a class="banner-btn normal-btn " href="catalog/all.php">Заказать</a>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="banner-block_detail"
                         style="background-image: url(k-store/static/images/home/banner_2.png)">
                        <img src="k-store/static/images/home/banner_img_2.png" alt="">
                        <a class="banner-btn normal-btn " href="catalog/all.php">Заказать</a>
                    </div>
                </div>
                <div class="col-12 col-lg-3">
                    <div class="banner-block_detail"
                         style="background-image: url(k-store/static/images/home/banner_3.png)">
                        <img src="k-store/static/images/home/banner_img_3.png" alt="">
                        <a class="banner-btn normal-btn " href="catalog/all.php">Заказать</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-10 col-md-6 col-lg-4 order-3 order-md-2 order-lg-2">
                <div class="row">
                    <div class="col-12">
                        <div class="featured-use text-md-right">
                            <div class="featured-use_intro order-2 order-md-1">
                                <h5>Выбор устройства</h5>
                                <p>Подбор устройства следует вести из ваших потребностей.
                                    Производительные ноутбуки имеют немалый вес и габариты.
                                    Для повседневного использования лучше выбрать Laptop, малые габариты позволят
                                    оперативно выполнять работу
                                    не требующих больших вычислительных мощностей в любом месте</p>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="featured-use text-md-right">
                            <div class="featured-use_intro order-2 order-md-1">
                                <h5>Модель ноутбука</h5>
                                <p>Каждый ноутбук имеет различную комплектацию.Разный объем оперативной памяти,
                                    разрешение экрана, размер жёсткиого и твердотельного диска.</p>
                            </div>
                            <div class="featured-use_icon text-md-right order-1 order-md-2 featured-use_icon-left">
                                <div class="icon-detail">
                                    <p>2<br>Шаг</p>
            ...
            <div class="col-12 col-md-12 col-lg-4 order-2 order-md-4 order-lg-3 text-center">
                <div class="week-product_img"><img class="img-fluid" src="k-store/static/images/home/deal-of-week.png"
                                                   alt="">
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="featured-use">
                            <div class="featured-use_intro order-2">
                                ...
                                <p>Доставка прямо к вам домой из нашего магазина или склада. Бесплатный подъём на этаж.
                                    Проверка комплектности и отсутствие внешних повреждений техники. В случае брака
                                    товар возвращается в магазин</p>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="featured-use">
                            <div class="featured-use_intro order-2">
                                <h5>Мы доставляем</h5>
                                <p>В распоряжении нашего магазина 20 курьеров с собственным автомобильным парком,
                                    который мы активно используем для доставки продукции нашим портнёра.</p>
                            </div>
                            <div class="featured-use_icon order-1 ml-0">
                                <div class="icon-detail">
                                    <p>4<br>Шаг</p>
